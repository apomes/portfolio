...
//            portfolioRootViewController.performSegue(
//                withIdentifier: "SegueToLockScreen",
//                sender: portfolioRootViewController)
            portfolioRootViewController.present(lockScreenViewController, animated: false, completion: nil)
